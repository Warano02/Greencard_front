...
const ProductsDetails = () => {
    ...
    useEffect(() => {
        if (products.length > 0) {
            ...
            productCopy = productCopy.filter((item) => item.category == item.category && item._id !== id)
    ...
    return product && (
        <div className="mt-12">
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="flex items-center gap-0.5 mt-1">
                        {Array(5).fill('').map((_, i) => (
                            <img src={i < 4 ? assets.star_icon : assets.star_dull_icon} alt="Rated" className='md:w-4 w-3.5' />
                        ))}
            ...
            <div className='flex flex-col items-center mt-20'>
                ...
                <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-6 mt-6 w-full'>
