...
function MainBanner() {
    return (
        <div className='relative'>
            ...
            <div className='absolute inset-0 flex  flex-col item-center md:item-start justify-end md:justify-center pb-24 md:pb-0 px-4 md:pl-18 lg:pl-24'>
                ...
                <div className='flex item-center mt-6 font-medium'>
                    ...
                    <Link to={"/products"} className='group gap-2 px-9 md:flex py-3 transition rounded text-black cursor-pointer'>Explore deals
